...
- [x] `Game.can_declare_end_game()` returns True when conditions met
- [x] Game does NOT auto-end when conditions met
- [x] `declare_end_game` WebSocket action triggers game end
- [x] Player can choose to continue playing (not declare)
- [x] `end_game_available` flag sent in player state when applicable
- [x] Unit tests for end-game declaration logic
