...
- [x] `get_public_state()` includes `merger_state` during STOCK_DISPOSITION phase
- [x] Queue shows player IDs, names, and completion status
- [x] Current player in queue is marked
- [x] Queue only present during merger stock disposition
- [x] Unit tests for queue visibility
