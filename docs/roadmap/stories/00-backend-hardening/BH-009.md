...
- [ ] Tests for room creation with unique codes
- [ ] Tests for player joining rooms
- [ ] Tests for player leaving/disconnecting
- [ ] Tests for room destruction
- [ ] Tests for multi-connection per player
- [ ] Tests for host connection management
- [ ] Tests for room code generation uniqueness
