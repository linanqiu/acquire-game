...
- [x] Tests for 3-way merger scenarios
- [x] Tests for 4-way merger (rare but possible)
- [x] Tests for tied majority stockholders (2, 3, 4 players)
- [x] Tests for tied minority stockholders
- [x] Tests for multi-chain defunct handling
- [x] Tests for merger with no stockholders
- [x] Tests for stock disposition when chain has no available stock to trade into
- [x] All new tests pass (17 tests)
- [x] Existing tests still pass (514 total)
