...
- [x] Tests for all ActionType enum values (3 tests)
- [x] Tests for Action creation with various parameters (8 tests)
- [x] Tests for action equality (`__eq__`) - implemented via dataclass
- [x] Tests for action hashing (`__hash__`) - implemented via dataclass
- [x] Tests for action serialization (to_dict, from_dict) (10 tests)
- [x] Tests for action string representation (4 tests)
- [x] Tests for optional fields (2 tests)
