...
- [ ] At least 5 full game simulation tests
- [ ] Tests verify valid phase transitions
- [ ] Tests verify money conservation (total money constant)
- [ ] Tests verify stock conservation (total stock constant)
- [ ] Tests cover: normal game end, 41+ tile chain, all safe chains
- [ ] Tests with 3, 4, 5, and 6 players
- [ ] Tests with pure bots, pure humans (simulated), and mixed
