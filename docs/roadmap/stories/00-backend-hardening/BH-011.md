...
- [ ] Tests for reconnection with valid token
- [ ] Tests for reconnection with invalid/expired token
- [ ] Tests for state sync after reconnection
- [ ] Tests for reconnection during player's turn
- [ ] Tests for reconnection during merger disposition
- [ ] Tests for multiple disconnects/reconnects
- [ ] All tests pass
