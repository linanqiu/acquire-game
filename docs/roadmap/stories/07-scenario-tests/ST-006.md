...
- [x] 6 merger scenarios implemented (5.1, 5.8, 5.9, 5.11, 5.15, 5.1-extended)
- [ ] Remaining 13 scenarios (5.2-5.7, 5.10, 5.12-5.14, 5.16-5.19)
- [ ] Survivor selection UI works for ties
- [x] Stock disposition modal shows all options (sell/trade/hold)
