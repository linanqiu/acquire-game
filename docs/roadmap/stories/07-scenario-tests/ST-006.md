...
- [ ] All 19 merger scenarios have passing tests
- [ ] Survivor selection UI works for ties
- [ ] Stock disposition modal shows all options
- [ ] Bonus calculations are correct and displayed
- [ ] Screenshots capture each phase of merger
