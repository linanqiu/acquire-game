...
- [x] Screenshot helper captures with timestamp and step name
- [x] Screenshots saved to `test-results/scenarios/`
- [x] Server health check before tests run
- [x] Game seeding API works for reproducible tests
- [x] Console errors captured and reported
- [x] Basic smoke test passes with screenshots
