...
- [ ] Icon variant: 8x8 colored square/logo
- [ ] Compact variant: icon + abbreviation (e.g., "[B] AME")
- [ ] Full variant: icon + name + size + price + available
- [ ] Safe chains display [SAFE] badge
- [ ] Correct colors for all 7 chains
- [ ] Abbreviations match spec (LUX, TWR, AME, FES, WOR, CON, IMP)
