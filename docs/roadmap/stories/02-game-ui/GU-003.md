...
- [ ] Coordinate label renders correctly
- [ ] Empty tile has neutral background
- [ ] Orphan tile has distinct color (#4a4a5a)
- [ ] Chain tiles show correct chain color
- [ ] Selected state: elevated shadow, bright border
- [ ] Disabled state: dimmed, lock icon
- [ ] Merger state: warning indicator (!!)
- [ ] Dead state: crossed out (X)
- [ ] Highlighted state: subtle glow
