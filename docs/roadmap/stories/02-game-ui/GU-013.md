...
- **Priority**: `critical`
- **Effort**: `L` (2-4 hours)
- **Dependencies**: GU-002, GU-006, FF-005, RT-002
...
- [ ] Large board readable from 10ft
- [ ] Chain panel shows all active chains with status
- [ ] Safe chains marked with badge
- [ ] Trade panel shows active trade or "No active trades"
- [ ] Scoreboard shows all players with stocks and cash
- [ ] Current player marked with > indicator
- [ ] Activity log shows recent events
- [ ] Room code visible in header
- [ ] Pre-game shows QR code and player list
- [ ] Bot add button in pre-game
- [ ] Start game button for host
- [ ] Minimum 18px body, 24px headers
- [ ] E2E test: host view updates
          ...
          <Panel title="ACTIVE TRADE">
            {activeTrade ? (
              <div className={styles.trade}>
                <p>{activeTrade.from} → {activeTrade.to}</p>
