...
- [ ] Lists each chain with non-zero holdings
- [ ] Shows: chain marker, quantity, price, total value
- [ ] Calculates total correctly (quantity × price)
- [ ] Shows portfolio total at bottom
