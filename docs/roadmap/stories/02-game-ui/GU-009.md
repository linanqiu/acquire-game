...
- [ ] Chains grouped by tier with labels
- [ ] Available chains are selectable
- [ ] Chains already on board are grayed out
- [ ] Selected chain has highlight
- [ ] Stock availability shown per chain
- [ ] Click triggers onSelect callback
- [ ] Chains with 0 stock available still selectable (no founder bonus)
