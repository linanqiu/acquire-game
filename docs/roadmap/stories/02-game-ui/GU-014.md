...
- [x] Winner announced with crown icon
- [x] Tie game handled (multiple crowns)
- [x] Rankings 1st through last
- [x] Total money shown for each player
- [x] Player view shows personal breakdown
- [x] Host view shows full breakdown table
- [x] Note for defunct stock worth $0
- [x] "Play Again" returns to lobby with same room (callback provided)
- [x] "Back to Lobby" returns to home page (callback provided)
- [x] Unit tests for ranking logic
    ...
    <Card title="GAME OVER">
      <div className={styles.winner}>
        {isTie ? (
          ...
          <>
            <span className={styles.crown}>👑 WINNER: {winners[0].name} 👑</span>
