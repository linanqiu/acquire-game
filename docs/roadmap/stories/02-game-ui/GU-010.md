...
- [x] Shows defunct chain name and player's share count
- [x] Shows defunct chain price
- [x] SELL slider: 0 to shares owned
- [x] TRADE slider: 0 to shares owned, step=2
- [x] TRADE disabled if survivor has no stock
- [x] HOLD = total - sell - trade (auto-calculated)
- [x] Cash from selling displayed
- [x] Survivor shares from trading displayed
- [x] Summary row before confirm
- [x] Confirm button submits disposition
