...
- [x] "Create Game" form with name input
- [x] "Join Game" form with name and room code inputs
- [x] Room code auto-capitalizes
- [x] Validation: name required, max 20 chars
- [x] Validation: room code 4 characters
- [x] Loading spinner on button while submitting
- [x] Error messages display inline
- [x] Create redirects to `/play/:room?is_host=1`
- [x] Join redirects to `/play/:room`
- [x] Responsive layout (mobile + desktop)
- [x] E2E test: create and join game flow
