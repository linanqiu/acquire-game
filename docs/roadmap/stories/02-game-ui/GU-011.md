...
- [x] Player selector shows all other players with their cash
- [x] "You Offer" section: add stocks (from your holdings), cash
- [x] "You Want" section: add stocks (from their holdings), cash
- [x] Cannot offer more than you have
- [x] Cannot request more than they have
- [x] Multiple stock types can be added
- [x] Clear validation errors
- [x] Cancel button resets form
- [x] Propose button submits trade
