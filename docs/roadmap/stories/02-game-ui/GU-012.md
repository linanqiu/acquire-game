...
- [ ] Header shows player name, room code, cash, tile pool status
- [ ] Phase indicator updates for each phase
- [ ] Pre-game lobby state shows player list
- [ ] Trading phase shows trade UI
- [ ] Tile placement phase shows board with tile selection
- [ ] Chain founding shows chain selector
- [ ] Merger shows disposition interface (when your turn)
- [ ] Stock buying shows cart interface
- [ ] Game over shows final scores
- [ ] Portfolio strip always visible during game
- [ ] Tile rack bottom-anchored during game
