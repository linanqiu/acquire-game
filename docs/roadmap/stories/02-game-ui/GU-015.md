...
- [x] Connection loss triggers reconnecting UI
- [x] Spinner animation during reconnection
- [x] Auto-reconnect within 5 seconds (3 attempts)
- [x] Success: toast "Welcome back", sync state (ReconnectedToast component provided)
- [x] Failure after timeout: show manual rejoin option
- [x] Manual rejoin button works
- [x] Game state synced correctly after reconnect (via props)
