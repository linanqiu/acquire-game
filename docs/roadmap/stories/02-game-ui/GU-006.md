...
- [ ] Player name displays prominently
- [ ] Cash formatted with $ and commas
- [ ] Stock holdings show chain abbreviation + count
- [ ] Current turn player has > marker
- [ ] Host badge displays when isHost=true
- [ ] Bot badge displays when isBot=true
