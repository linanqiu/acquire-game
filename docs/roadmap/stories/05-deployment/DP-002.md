...
- [x] All secrets stored as env vars (not in code)
- [ ] Railway variables configured (requires Railway project)
- [x] Application reads from environment
- [x] Local development uses .env file
- [x] .env.example documents all variables
- [x] Production uses secure defaults
