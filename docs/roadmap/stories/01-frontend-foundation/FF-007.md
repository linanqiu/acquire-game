...
- [x] TextInput renders with label, placeholder, value
- [x] TextInput shows error message when provided
- [x] TextInput respects maxLength
- [x] TextInput autoCapitalize works for room codes
- [x] Select renders options and handles selection
- [x] RadioGroup renders options with selection state
