...
- [x] Modal renders centered over content
- [x] Backdrop darkens background
- [x] Title displays in header
- [x] Close button (×) closes modal
- [x] Escape key closes modal
- [x] Click on backdrop closes modal
- [x] Confirm/Cancel buttons work
- [x] Focus moves to modal on open
- [x] Focus returns to trigger on close
- [x] Tab cycles only through modal elements
