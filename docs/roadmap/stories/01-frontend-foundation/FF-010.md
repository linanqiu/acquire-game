...
- [x] `/` renders Lobby page
- [x] `/play/:room` renders Player View with room param
- [x] `/host/:room` renders Host View with room param
- [x] Unknown routes show 404 page
- [x] Room code extracted from URL is accessible
