...
- [x] Toast renders with correct styling per type
- [x] Toasts auto-dismiss after duration (default 5s)
- [x] Toasts can be manually dismissed
- [x] Multiple toasts stack vertically
- [x] `useToast()` hook provides `toast()` function
- [x] Slide animation on enter/exit
- [x] Icons for each toast type
- [x] Unit tests for toast behavior
