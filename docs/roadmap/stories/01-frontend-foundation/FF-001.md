...
- [x] `npm run dev` starts development server on port 5173
- [x] `npm run build` produces production bundle in `dist/`
- [x] `npm run test` runs Vitest unit tests
- [x] `npm run e2e` runs Playwright tests
- [x] `npm run lint` checks code with ESLint
- [x] `npm run format` formats code with Prettier
- [x] TypeScript strict mode enabled
- [x] Project structure follows convention below
