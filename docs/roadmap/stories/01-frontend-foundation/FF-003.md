...
- [x] IBM Plex Mono loads correctly
- [x] Fallback fonts defined (Fira Code, Consolas, monospace)
- [x] Type scale variables defined (--text-xs through --text-xl)
- [x] Font weights defined (normal, medium, bold)
- [x] Body text renders in monospace
- [x] Numbers align in tabular format
