...
- [ ] Utility classes for all background colors
- [ ] Utility classes for all text colors
- [ ] Chain color utilities (bg and text)
- [ ] Status color utilities (success, error)
- [ ] Body has dark background by default
- [ ] All text/background combos pass WCAG AA contrast
